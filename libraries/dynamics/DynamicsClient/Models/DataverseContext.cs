...
namespace Libraries.Dynamics.DynamicsClient
{
	...
	public partial class DataverseContext : Microsoft.Xrm.Sdk.Client.OrganizationServiceContext
	{
		...
		/// <summary>
		/// Gets a binding to the set of all <see cref="Libraries.Dynamics.DynamicsClient.Account"/> entities.
		/// </summary>
		public System.Linq.IQueryable<Libraries.Dynamics.DynamicsClient.Account> AccountSet
		{
			get
			{
				return this.CreateQuery<Libraries.Dynamics.DynamicsClient.Account>();
			}
		}
		
		/// <summary>
		/// Gets a binding to the set of all <see cref="Libraries.Dynamics.DynamicsClient.Contact"/> entities.
		/// </summary>
		public System.Linq.IQueryable<Libraries.Dynamics.DynamicsClient.Contact> ContactSet
		{
			get
			{
				return this.CreateQuery<Libraries.Dynamics.DynamicsClient.Contact>();
			}
		}
	}
